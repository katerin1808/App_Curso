...
namespace AppCurso1._1
{
    class Global
    {
        ...
        {
            new Datos(1,"Conceptos básicos de Bases de Datos en Excel | Gestión de la Información #1 ","https://goo.gl/Rof9Yf",1),
            new Datos(2,"Ejemplos de Bases de Datos en Excel | Gestión de la Información #2","https://goo.gl/iUF2rL",2),
            new Datos(3,"Diversos ejemplos de Bases de Datos en Excel | Gestión de la Información #3","https://goo.gl/baXcJW",3),
            new Datos(4,"¿Que es una Tabla Resumen en Excel y que es una Base de Datos? | Gestión de la Información #4","https://goo.gl/hj8vYo",4)
        };
